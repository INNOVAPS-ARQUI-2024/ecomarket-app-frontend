...
const routes: Routes = [
  ...
  { path: 'lista-servicios', component: ListaServiciosComponent, canActivate: [AuthGuard], data: { role: 'Vendedor' } },
  { path: 'modificar-servicio', component: ModificarServicioComponent, canActivate: [AuthGuard], data: { role: 'Vendedor' } },
];
